...
class BlockN(nn.Module):
    ...
    def __init__(self, dim1, dim2, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        self.attn = CrossAttentionN(dim1=dim1, dim2=dim2, num_heads=num_heads, pool_ratio=pool_ratio)
...
class APFormerHeadSingle(BaseDecodeHead):
    ...
    def __init__(self, feature_strides, pool_scales=(1, 2, 3, 6), **kwargs):
        ...
        self.attn_c4 = BlockN(dim1=c4_in_channels, dim2=c4_in_channels, num_heads=8, mlp_ratio=4,
                                drop_path=0.1, pool_ratio=8)
        self.attn_c3 = BlockN(dim1=c3_in_channels, dim2=c4_in_channels, num_heads=5, mlp_ratio=4,
                                drop_path=0.1, pool_ratio=4)
        self.attn_c2 = BlockN(dim1=c2_in_channels, dim2=c3_in_channels, num_heads=2, mlp_ratio=4,
                                drop_path=0.1, pool_ratio=2)
        self.attn_c1 = BlockN(dim1=c1_in_channels, dim2=c2_in_channels, num_heads=1, mlp_ratio=4,
                                drop_path=0.1, pool_ratio=1)
    ...
    def forward(self, inputs):
        ...
        c4 = c4.flatten(2).transpose(1, 2)
        _c4 = self.attn_c4(c4, c4, h4, w4, h4, w4)
        _c4 = _c4.permute(0,2,1).reshape(n, -1, h4, w4)

        c3 = c3.flatten(2).transpose(1, 2)
        _c3 = self.attn_c3(c3, _c4, h4, w4, h3, w3)
        _c3 = _c3.permute(0,2,1).reshape(n, -1, h3, w3)

        c2 = c2.flatten(2).transpose(1, 2)
        _c2 = self.attn_c2(c2, _c3, h4, w4, h2, w2)
        _c2 = _c2.permute(0,2,1).reshape(n, -1, h2, w2)

        c1 = c1.flatten(2).transpose(1, 2)
        _c1 = self.attn_c1(c1, _c2, h4, w4, h1, w1)
