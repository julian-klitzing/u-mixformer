...
PORT=29050 sh tools/dist_test.sh configs/remixformer/remixformer_mit-b0_8xb1-160k_cityscapes-1024x1024.py checkpoints/segmentation/remixformer/cityscapes/remixformer.b0.1024.city.160k.pth 2
